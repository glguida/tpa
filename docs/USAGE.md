...
- YOLO full/demo host launcher integration, YOLO block-test CTest wiring, tensor matmul, DNN demos, and ltfarm experiments still need ordered porting into the structured tree.
