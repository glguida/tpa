...
per-scale P3/P4/P5 C2f+Detect, dense P5 C2f+Detect, combined P3/P4/P5
C2f+Detect, and all-scale source/detect/checker processes, maps
`yolov8n_p5_detect.tpp`, `yolov8n_p3_c2f_detect.tpp`,
`yolov8n_p4_c2f_detect.tpp`, `yolov8n_p5_c2f_detect.tpp`,
...
targets validate sampled and dense-P5 C2f/Detect/DFL plumbing with
...
- YOLOv5n downstream planner/map/device ELF and Erbium PASS-marker runtime
  ...
  dense P5 C2f feature-map validation feeding sampled P5 Detect; full/demo host
