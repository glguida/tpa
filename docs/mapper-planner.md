...
per-scale P3/P4/P5 C2f+Detect, dense P4/P5 C2f+Detect, combined P3/P4/P5
...
`tpa_yolov8n_p3_c2f_detect.elf`, `tpa_yolov8n_p4_c2f_detect.elf`,
...
targets validate sampled and dense-P4/P5 C2f/Detect/DFL plumbing with
...
- YOLOv5n downstream planner/map/device ELF and Erbium PASS-marker runtime
  ...
  Detect/DFL, a sampled combined P3/P4/P5 C2f+Detect downstream graph, dense P4
  C2f feature-map validation feeding sampled P4 Detect, and dense P5 C2f
  feature-map validation feeding sampled P5 Detect; full/demo host
