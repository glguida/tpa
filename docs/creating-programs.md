...
tests, YOLO block-test CTest wiring, YOLO model/tool regeneration, and the full
cooperative runtime scheduler. Original DNN demos and LTFarm are preserved under
