...
intended FAIL marker. The packed-single row micro-example, tensor matmul,
fast attention, stereo SAD, YOLOv5n downstream, and the opt-in YOLOv8n
Detect/DFL/C2f/neck-tail external-header
