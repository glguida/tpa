#ifndef LTFARM_LITECOIN_CORE_VECTORS_H
#define LTFARM_LITECOIN_CORE_VECTORS_H

#include <stddef.h>

/*
 * Official Litecoin Core scrypt vectors copied from:
 *   src/test/scrypt_tests.cpp
 * in litecoin-project/litecoin commit:
 *   022b7ea5b33d88b61d46338ce9a96384345931db
 */

typedef struct {
    const char *input_hex;
    const char *expected_hex;
} ltfarm_litecoin_core_vector_t;

static const ltfarm_litecoin_core_vector_t kLTFarmLitecoinCoreVectors[] = {
    {
...
static const size_t kLTFarmLitecoinCoreVectorCount =
    sizeof(kLTFarmLitecoinCoreVectors) / sizeof(kLTFarmLitecoinCoreVectors[0]);
