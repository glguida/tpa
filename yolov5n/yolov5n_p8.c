...
#include "generated/yolov5n_l59_tensor_weights.h"
#include "generated/yolov5n_l60_tensor_weights.h"
#include "generated/yolov5n_l70_tensor_weights.h"
#include "generated/yolov5n_l65_tensor_weights.h"
#include "generated/yolov5n_l66_tensor_weights.h"
#include "generated/yolov5n_l73_tensor_weights.h"
...
#define BOX_C      64u
#define CLS_C      80u
#define YV5N_P8_ACC_BYTES    (sizeof(int32_t) * PIX_BLOCK * OC_BLOCK)
#define YV5N_P8_PACKED_BYTES (PIX_BLOCK * 128u)
#define YV5N_P8_PATCH_BYTES  (PIX_BLOCK * 768u)
#define YV5N_P8_SCRATCH_PEAK_BYTES \
    (YV5N_ARENA_STEP(0u, NR_PIX * CLS_C, 64u) + \
     (NR_PIX * CLS_C) + \
     YV5N_P8_ACC_BYTES + \
     YV5N_P8_PACKED_BYTES + \
     YV5N_P8_PATCH_BYTES)
...
tpa_op_t yolo_full_p8_start(void);
tpa_op_t yolo_full_p8_run(void);
tpa_op_t yolo_full_p8_send_cls(void);
tpa_op_t yolo_full_p8_done(void);
...
TPA_PROC_MEM_META(yolov5n_p8_mem_meta, 508u, YV5N_P8_SCRATCH_PEAK_BYTES);

static const yolov5n_layer_meta_t layer59_meta = {
    .lut = yv5n_model_24_cv2_1_0_lut,
    .c_in = 128u,
    .k_out = 64u,
    .k_h = 3u,
    .k_w = 3u,
    .act_in_scale = 1.74814585e-02f,
    .act_out_scale = 2.65586526e-02f,
};

static const yolov5n_layer_meta_t layer60_meta = {
    .lut = yv5n_model_24_cv2_1_1_lut,
    .c_in = 64u,
    .k_out = 64u,
    .k_h = 3u,
    .k_w = 3u,
    .act_in_scale = 2.65586526e-02f,
    .act_out_scale = 1.03506006e-01f,
};

static const yolov5n_layer_meta_t layer70_meta = {
    .lut = NULL,
    .c_in = 64u,
    .k_out = 64u,
    .k_h = 1u,
    .k_w = 1u,
    .act_in_scale = 1.03506006e-01f,
    .act_out_scale = 7.34780830e-02f,
};

static const yolov5n_layer_meta_t layer65_meta = {
    .lut = yv5n_model_24_cv3_1_0_lut,
    .c_in = 128u,
    .k_out = 80u,
    .k_h = 3u,
    .k_w = 3u,
    .act_in_scale = 1.74814585e-02f,
    .act_out_scale = 2.16717157e-02f,
};

static const yolov5n_layer_meta_t layer66_meta = {
    .lut = yv5n_model_24_cv3_1_1_lut,
    .c_in = 80u,
    .k_out = 80u,
    .k_h = 3u,
    .k_w = 3u,
    .act_in_scale = 2.16717157e-02f,
    .act_out_scale = 8.74528735e-02f,
    .exact_post = 1u,
};

static const yolov5n_layer_meta_t layer73_meta = {
    .lut = NULL,
    .c_in = 80u,
    .k_out = 80u,
    .k_h = 1u,
    .k_w = 1u,
    .act_in_scale = 8.74528735e-02f,
    .act_out_scale = 1.36029221e-01f,
    .exact_post = 1u,
};

static const tensor_layer_t layer59 = {
    .ld = &layer59_meta,
    .tl8_b = yolov5n_l59_tl8_b,
    .bias_blk = yolov5n_l59_bias_blk,
    .scale_blk = yolov5n_l59_scale_blk,
    .oc_blocks = YOLOV5N_L59_TENSOR_OC_BLOCKS,
    .k_inner = YOLOV5N_L59_TENSOR_K_INNER,
    .k_padded = YOLOV5N_L59_TENSOR_K_PADDED,
    .k_block = YOLOV5N_L59_TENSOR_K_BLOCK,
    .k_blocks = YOLOV5N_L59_TENSOR_K_BLOCKS,
    .tl8_row_stride = YOLOV5N_L59_TL8_ROW_STRIDE,
};

static const tensor_layer_t layer60 = {
    .ld = &layer60_meta,
    .tl8_b = yolov5n_l60_tl8_b,
    .bias_blk = yolov5n_l60_bias_blk,
    .scale_blk = yolov5n_l60_scale_blk,
    .oc_blocks = YOLOV5N_L60_TENSOR_OC_BLOCKS,
    .k_inner = YOLOV5N_L60_TENSOR_K_INNER,
    .k_padded = YOLOV5N_L60_TENSOR_K_PADDED,
    .k_block = YOLOV5N_L60_TENSOR_K_BLOCK,
    .k_blocks = YOLOV5N_L60_TENSOR_K_BLOCKS,
    .tl8_row_stride = YOLOV5N_L60_TL8_ROW_STRIDE,
};

static const tensor_layer_t layer70 = {
    .ld = &layer70_meta,
    .tl8_b = yolov5n_l70_tl8_b,
    .bias_blk = yolov5n_l70_bias_blk,
    .scale_blk = yolov5n_l70_scale_blk,
    .oc_blocks = YOLOV5N_L70_TENSOR_OC_BLOCKS,
    .k_inner = YOLOV5N_L70_TENSOR_K_INNER,
    .k_padded = YOLOV5N_L70_TENSOR_K_PADDED,
    .k_block = YOLOV5N_L70_TENSOR_K_BLOCK,
    .k_blocks = YOLOV5N_L70_TENSOR_K_BLOCKS,
    .tl8_row_stride = YOLOV5N_L70_TL8_ROW_STRIDE,
};

static const tensor_layer_t layer65 = {
    .ld = &layer65_meta,
    .tl8_b = yolov5n_l65_tl8_b,
    .bias_blk = yolov5n_l65_bias_blk,
    .scale_blk = yolov5n_l65_scale_blk,
    .oc_blocks = YOLOV5N_L65_TENSOR_OC_BLOCKS,
    .k_inner = YOLOV5N_L65_TENSOR_K_INNER,
    .k_padded = YOLOV5N_L65_TENSOR_K_PADDED,
    .k_block = YOLOV5N_L65_TENSOR_K_BLOCK,
    .k_blocks = YOLOV5N_L65_TENSOR_K_BLOCKS,
    .tl8_row_stride = YOLOV5N_L65_TL8_ROW_STRIDE,
};

static const tensor_layer_t layer66 = {
    .ld = &layer66_meta,
    .tl8_b = yolov5n_l66_tl8_b,
    .bias_blk = yolov5n_l66_bias_blk,
    .scale_blk = yolov5n_l66_scale_blk,
    .oc_blocks = YOLOV5N_L66_TENSOR_OC_BLOCKS,
    .k_inner = YOLOV5N_L66_TENSOR_K_INNER,
    .k_padded = YOLOV5N_L66_TENSOR_K_PADDED,
    .k_block = YOLOV5N_L66_TENSOR_K_BLOCK,
    .k_blocks = YOLOV5N_L66_TENSOR_K_BLOCKS,
    .tl8_row_stride = YOLOV5N_L66_TL8_ROW_STRIDE,
};

static const tensor_layer_t layer73 = {
    .ld = &layer73_meta,
    .tl8_b = yolov5n_l73_tl8_b,
    .bias_blk = yolov5n_l73_bias_blk,
    .scale_blk = yolov5n_l73_scale_blk,
    .oc_blocks = YOLOV5N_L73_TENSOR_OC_BLOCKS,
    .k_inner = YOLOV5N_L73_TENSOR_K_INNER,
    .k_padded = YOLOV5N_L73_TENSOR_K_PADDED,
    .k_block = YOLOV5N_L73_TENSOR_K_BLOCK,
    .k_blocks = YOLOV5N_L73_TENSOR_K_BLOCKS,
    .tl8_row_stride = YOLOV5N_L73_TL8_ROW_STRIDE,
};
...
tpa_op_t yolo_full_p8_start(void)
{
    yolo_full_p8_ws_t *w = tpa_ws();

    return tpa_recv(tpa_chan(0), (void **)&w->in, &w->in_len, yolo_full_p8_run);
}
...
tpa_op_t yolo_full_p8_run(void)
{
    ...
    YV5N_REQUIRE_MSG_STOP("P8:LEN\n", w->in_len == INPUT_H * INPUT_W * INPUT_C);

    yolov5n_arena_begin(YV5N_P8_SCRATCH_PEAK_BYTES);
    ...
    YV5N_REQUIRE_MSG_STOP("P8:ALLOC\n", det_stage0_buf && det_stage1_buf &&
                          acc_blk_scratch && packed_scratch && patch_scratch);

    enable_tensor_scratchpad();
    YV5N_TRY_MSG_STOP("P8:L59\n", run_conv3x3_layer_exact(&layer59, w->in, 128u, box1_buf, 64u));
    YV5N_TRY_MSG_STOP("P8:L60\n", run_conv3x3_layer_packed(&layer60, box1_buf, 64u, box2_buf, 64u));
    if (demo_outputs) {
        w->demo_box_out = yolov5n_send_buf(tpa_chan(1));
        YV5N_TRY_MSG_STOP("P8:L70D\n", run_conv1x1_layer(&layer70, box2_buf, 64u, w->demo_box_out, 64u));
    } else {
        YV5N_TRY_MSG_STOP("P8:L70\n", run_conv1x1_layer(&layer70, box2_buf, 64u, box_buf, 64u));
    }
    YV5N_TRY_MSG_STOP("P8:L65\n", run_conv3x3_layer_exact(&layer65, w->in, 128u, cls1_buf, 80u));
    YV5N_TRY_MSG_STOP("P8:L66\n", run_conv3x3_layer_packed(&layer66, cls1_buf, 80u, cls2_buf, 80u));
    if (demo_outputs) {
        w->demo_cls_out = yolov5n_send_buf(tpa_chan(2));
        YV5N_TRY_MSG_STOP("P8:L73D\n", run_conv1x1_layer(&layer73, cls2_buf, 80u, w->demo_cls_out, 80u));
    } else {
        YV5N_TRY_MSG_STOP("P8:L73\n", run_conv1x1_layer(&layer73, cls2_buf, 80u, cls_buf, 80u));
    }

    if (demo_outputs) {
        return tpa_send(tpa_chan(1), w->demo_box_out, YV5N_DEMO_P8_BOX_BYTES,
                        yolo_full_p8_send_cls);
    }
...
tpa_op_t yolo_full_p8_send_cls(void)
{
    ...
    return tpa_send(tpa_chan(2), w->demo_cls_out, YV5N_DEMO_P8_CLS_BYTES,
                    yolo_full_p8_done);
}
