...
#define YV8N_P4_C2F_TRACE_BEGIN 0xe8c4f000u
#define YV8N_P4_C2F_TRACE_SOURCE_SENT 0xe8c4f001u
#define YV8N_P4_C2F_TRACE_C2F_DONE 0xe8c4f002u
#define YV8N_P4_C2F_TRACE_DETECT_DONE 0xe8c4f003u
#define YV8N_P4_C2F_TRACE_CHECK_PASS 0xe8c4f004u
#define YV8N_P4_C2F_TRACE_FAIL 0xe8c4feeu

#define YV8N_P4_C2F_SOURCE_PID 840u
#define YV8N_P4_C2F_PID 841u
#define YV8N_P4_C2F_DETECT_PID 842u
#define YV8N_P4_C2F_CHECKER_PID 843u

#define YV8N_P4_C2F_IN_H 40u
#define YV8N_P4_C2F_IN_W 40u
#define YV8N_P4_C2F_IN_C 192u
#define YV8N_P4_C2F_OUT_C 128u
#define YV8N_P4_C2F_HIDDEN_C 64u
#define YV8N_P4_C2F_CAT_C (3u * YV8N_P4_C2F_HIDDEN_C)
#define YV8N_P4_C2F_POINTS (YV8N_P4_C2F_IN_H * YV8N_P4_C2F_IN_W)
#define YV8N_P4_C2F_INPUT_BYTES (YV8N_P4_C2F_POINTS * YV8N_P4_C2F_IN_C)
#define YV8N_P4_C2F_OUTPUT_BYTES (YV8N_P4_C2F_POINTS * YV8N_P4_C2F_OUT_C)
#define YV8N_P4_C2F_SCRATCH_PEAK_BYTES 4096u
#define YV8N_P4_C2F_DETECT_SAMPLE_POINTS 8u
#define YV8N_P4_C2F_MAX_COMPUTED_POINTS (YV8N_P4_C2F_DETECT_SAMPLE_POINTS * 9u)
#define YV8N_P4_C2F_SUMMARY_MAGIC UINT32_C(0x59384334) /* "Y8C4" */
#define YV8N_P4_C2F_SUMMARY_VERSION 1u

#define YV8N_P4_C2F_CV1_ID 4u
#define YV8N_P4_C2F_B0_CV1_ID 5u
#define YV8N_P4_C2F_B0_CV2_ID 6u
#define YV8N_P4_C2F_CV2_ID 7u
#define YV8N_P4_C2F_BOX0_ID 15u
#define YV8N_P4_C2F_BOX1_ID 16u
#define YV8N_P4_C2F_BOX2_ID 17u
#define YV8N_P4_C2F_CLS0_ID 24u
#define YV8N_P4_C2F_CLS1_ID 25u
#define YV8N_P4_C2F_CLS2_ID 26u
#define YV8N_P4_C2F_DFL_ID 30u

#define FNV1A64_INIT UINT64_C(0xcbf29ce484222325)
#define FNV1A64_PRIME UINT64_C(0x100000001b3)

#define YV8N_P4_C2F_EXPECT_INPUT_HASH UINT64_C(0x6da53b6d0122b9a5)
#define YV8N_P4_C2F_EXPECT_LAYER_HASH UINT64_C(0xc759e3e9b51565bc)
#define YV8N_P4_C2F_EXPECT_OUTPUT_HASH UINT64_C(0x6fdfb8321c48aac9)
#define YV8N_P4_C2F_EXPECT_SAMPLED_HASH UINT64_C(0xa73642a88f7da731)
#define YV8N_P4_C2F_EXPECT_POINT_HASH UINT64_C(0x145219f0a91bdee2)
#define YV8N_P4_C2F_EXPECT_COMPUTED_POINTS 40u
#define YV8N_P4_C2F_EXPECT_FIRST0 -11
#define YV8N_P4_C2F_EXPECT_FIRST1 -8
#define YV8N_P4_C2F_EXPECT_FIRST2 -10
#define YV8N_P4_C2F_EXPECT_FIRST3 -11

#define YV8N_P4_C2F_DETECT_EXPECT_RAW_HASH UINT64_C(0xeeabc74cac1619a8)
#define YV8N_P4_C2F_DETECT_EXPECT_BOX_HASH UINT64_C(0x7e6e912c69e8157b)
#define YV8N_P4_C2F_DETECT_EXPECT_CLS_HASH UINT64_C(0xccf1a1f80e179625)
#define YV8N_P4_C2F_DETECT_EXPECT_PUBLIC_HASH UINT64_C(0x8ca3a02ace2330c7)
#define YV8N_P4_C2F_DETECT_EXPECT_FIRST0 2136
#define YV8N_P4_C2F_DETECT_EXPECT_FIRST1 3768
#define YV8N_P4_C2F_DETECT_EXPECT_FIRST2 30960
#define YV8N_P4_C2F_DETECT_EXPECT_FIRST3 38160
...
typedef struct {
    ...
    uint32_t reserved[5];
} yolov8n_p4_c2f_summary_t;

TPA_STATIC_ASSERT(sizeof(yolov8n_p4_c2f_summary_t) == 160u,
                  "YOLOv8n P4 C2f summary edge size must match .tpp");

typedef struct {
    const int8_t *input;
    uint32_t input_len;
    int8_t *output;
    yolov8n_p4_c2f_summary_t summary;
} c2f_ws_t;
...
typedef struct {
    const yolov8n_p4_c2f_summary_t *c2f_summary;
...
typedef struct {
    int8_t cv1_tmp[2 * YV8N_P4_C2F_HIDDEN_C];
    int8_t chunk1_patch5[25 * YV8N_P4_C2F_HIDDEN_C];
    int8_t chunk0_center[YV8N_P4_C2F_HIDDEN_C];
    int8_t chunk1_center[YV8N_P4_C2F_HIDDEN_C];
    int8_t conv0_patch3[9 * YV8N_P4_C2F_HIDDEN_C];
    int8_t conv1_out[YV8N_P4_C2F_HIDDEN_C];
    int8_t bottleneck[YV8N_P4_C2F_HIDDEN_C];
    int8_t cat[YV8N_P4_C2F_CAT_C];
    uint8_t patch5_valid[25];
    uint8_t patch3_valid[9];
} c2f_scratch_t;

TPA_STATIC_ASSERT(sizeof(c2f_scratch_t) <= YV8N_P4_C2F_SCRATCH_PEAK_BYTES,
                  "YOLOv8n P4 C2f scratch declaration is too small");

tpa_op_t yolov8n_p4_c2f_input_source_start(void);
tpa_op_t yolov8n_p4_c2f_input_source_done(void);
tpa_op_t yolov8n_p4_c2f_start(void);
tpa_op_t yolov8n_p4_c2f_run(void);
tpa_op_t yolov8n_p4_c2f_send_summary(void);
tpa_op_t yolov8n_p4_c2f_done(void);
tpa_op_t yolov8n_p4_c2f_detect_start(void);
tpa_op_t yolov8n_p4_c2f_detect_run(void);
tpa_op_t yolov8n_p4_c2f_detect_done(void);
tpa_op_t yolov8n_p4_c2f_detect_checker_start(void);
tpa_op_t yolov8n_p4_c2f_detect_checker_recv_detect(void);
tpa_op_t yolov8n_p4_c2f_detect_checker_run(void);

TPA_PROC_MEM_META(yolov8n_p4_c2f_input_source_meta,
                  YV8N_P4_C2F_SOURCE_PID, 0u);
TPA_PROC_MEM_META(yolov8n_p4_c2f_meta,
                  YV8N_P4_C2F_PID, YV8N_P4_C2F_SCRATCH_PEAK_BYTES);
TPA_PROC_MEM_META(yolov8n_p4_c2f_detect_meta,
                  YV8N_P4_C2F_DETECT_PID, YV8N_DETECT_SCRATCH_PEAK_BYTES);
TPA_PROC_MEM_META(yolov8n_p4_c2f_detect_checker_meta,
                  YV8N_P4_C2F_CHECKER_PID, 0u);

static const uint32_t sample_points[YV8N_P4_C2F_DETECT_SAMPLE_POINTS] = {
...
static uint64_t hash_c2f_layers(void)
{
    static const uint32_t layer_ids[] = {
        YV8N_P4_C2F_CV1_ID,
        YV8N_P4_C2F_B0_CV1_ID,
        YV8N_P4_C2F_B0_CV2_ID,
        YV8N_P4_C2F_CV2_ID,
    };
...
{
    static const uint32_t layer_ids[] = {
        YV8N_P4_C2F_BOX0_ID, YV8N_P4_C2F_BOX1_ID, YV8N_P4_C2F_BOX2_ID,
        YV8N_P4_C2F_CLS0_ID, YV8N_P4_C2F_CLS1_ID, YV8N_P4_C2F_CLS2_ID,
        YV8N_P4_C2F_DFL_ID,
    };
...
static int verify_c2f_layers(void)
{
    const yolov8n_external_detect_c2f_layer_t *cv1 =
        &yolov8n_external_detect_c2f_layers[YV8N_P4_C2F_CV1_ID];
    const yolov8n_external_detect_c2f_layer_t *b0_cv1 =
        &yolov8n_external_detect_c2f_layers[YV8N_P4_C2F_B0_CV1_ID];
    const yolov8n_external_detect_c2f_layer_t *b0_cv2 =
        &yolov8n_external_detect_c2f_layers[YV8N_P4_C2F_B0_CV2_ID];
    const yolov8n_external_detect_c2f_layer_t *cv2 =
        &yolov8n_external_detect_c2f_layers[YV8N_P4_C2F_CV2_ID];
...
static int verify_detect_layers(void)
{
    const yolov8n_external_detect_c2f_layer_t *box0 =
        &yolov8n_external_detect_c2f_layers[YV8N_P4_C2F_BOX0_ID];
    const yolov8n_external_detect_c2f_layer_t *box1 =
        &yolov8n_external_detect_c2f_layers[YV8N_P4_C2F_BOX1_ID];
    const yolov8n_external_detect_c2f_layer_t *box2 =
        &yolov8n_external_detect_c2f_layers[YV8N_P4_C2F_BOX2_ID];
    const yolov8n_external_detect_c2f_layer_t *cls0 =
        &yolov8n_external_detect_c2f_layers[YV8N_P4_C2F_CLS0_ID];
    const yolov8n_external_detect_c2f_layer_t *cls1 =
        &yolov8n_external_detect_c2f_layers[YV8N_P4_C2F_CLS1_ID];
    const yolov8n_external_detect_c2f_layer_t *cls2 =
        &yolov8n_external_detect_c2f_layers[YV8N_P4_C2F_CLS2_ID];
    const yolov8n_external_detect_c2f_layer_t *dfl =
        &yolov8n_external_detect_c2f_layers[YV8N_P4_C2F_DFL_ID];
    ...
    if (box2->K_out != 64u || box2->C_in != 64u || box2->kH != 1u ||
        box2->kW != 1u)
        return -1;
    if (cls0->K_out != 80u || cls0->C_in != 128u || cls0->kH != 3u ||
...
{
    for (uint32_t y = 0; y < YV8N_P4_C2F_IN_H; ++y) {
        for (uint32_t x = 0; x < YV8N_P4_C2F_IN_W; ++x) {
            for (uint32_t c = 0; c < YV8N_P4_C2F_IN_C; ++c) {
                size_t idx = (((size_t)y * YV8N_P4_C2F_IN_W + x) *
                              YV8N_P4_C2F_IN_C) + c;
...
static void fill_c2f_output_sentinel(int8_t *out)
{
    for (uint32_t y = 0; y < YV8N_P4_C2F_IN_H; ++y) {
        for (uint32_t x = 0; x < YV8N_P4_C2F_IN_W; ++x) {
            for (uint32_t c = 0; c < YV8N_P4_C2F_OUT_C; ++c) {
                size_t idx = (((size_t)y * YV8N_P4_C2F_IN_W + x) *
                              YV8N_P4_C2F_OUT_C) + c;
...
static uint32_t c2f_needed_points(uint32_t *points)
{
    ...
    for (uint32_t i = 0; i < YV8N_P4_C2F_DETECT_SAMPLE_POINTS; ++i) {
        int32_t cy = (int32_t)(sample_points[i] / YV8N_P4_C2F_IN_W);
        int32_t cx = (int32_t)(sample_points[i] % YV8N_P4_C2F_IN_W);
        ...
        for (int32_t dy = -1; dy <= 1; ++dy) {
            for (int32_t dx = -1; dx <= 1; ++dx) {
                ...
                if (y < 0 || y >= (int32_t)YV8N_P4_C2F_IN_H ||
                    x < 0 || x >= (int32_t)YV8N_P4_C2F_IN_W)
                    continue;
                count = add_unique_point(
                    points, count, (uint32_t)y * YV8N_P4_C2F_IN_W + (uint32_t)x);
            }
        }
    }
                              ...
                              int8_t *out)
{
    ...
    const yolov8n_external_detect_c2f_layer_t *cv2 =
        &yolov8n_external_detect_c2f_layers[YV8N_P4_C2F_CV2_ID];
    int32_t cy = (int32_t)(point / YV8N_P4_C2F_IN_W);
    int32_t cx = (int32_t)(point % YV8N_P4_C2F_IN_W);
    ...
    for (int32_t dy = -2; dy <= 2; ++dy) {
        for (int32_t dx = -2; dx <= 2; ++dx) {
            ...
            int8_t *chunk1 = s->chunk1_patch5 +
                             (size_t)patch_idx * YV8N_P4_C2F_HIDDEN_C;

            if (y < 0 || y >= (int32_t)YV8N_P4_C2F_IN_H ||
                x < 0 || x >= (int32_t)YV8N_P4_C2F_IN_W)
                continue;

            conv1x1_hwc_at(cv1, input, YV8N_P4_C2F_IN_H,
                           YV8N_P4_C2F_IN_W, YV8N_P4_C2F_IN_C,
                           (uint32_t)y, (uint32_t)x, s->cv1_tmp);
            for (uint32_t c = 0; c < YV8N_P4_C2F_HIDDEN_C; ++c) {
                if (dy == 0 && dx == 0) {
                    s->chunk0_center[c] = s->cv1_tmp[c];
                    s->chunk1_center[c] = s->cv1_tmp[YV8N_P4_C2F_HIDDEN_C + c];
                }
                chunk1[c] = s->cv1_tmp[YV8N_P4_C2F_HIDDEN_C + c];
            }
    ...
    for (int32_t dy = -1; dy <= 1; ++dy) {
        for (int32_t dx = -1; dx <= 1; ++dx) {
            ...
            int8_t *conv0 = s->conv0_patch3 +
                            (size_t)patch3_idx * YV8N_P4_C2F_HIDDEN_C;

            if (y < 0 || y >= (int32_t)YV8N_P4_C2F_IN_H ||
                x < 0 || x >= (int32_t)YV8N_P4_C2F_IN_W)
                continue;
            conv3x3_from_patch(b0_cv1, s->chunk1_patch5, 5u,
                               YV8N_P4_C2F_HIDDEN_C, s->patch5_valid,
    ...
    conv3x3_from_patch(b0_cv2, s->conv0_patch3, 3u,
                       YV8N_P4_C2F_HIDDEN_C, s->patch3_valid,
                       1u, 1u, s->conv1_out);
    ...
    for (uint32_t c = 0; c < YV8N_P4_C2F_HIDDEN_C; ++c) {
        ...
        s->cat[YV8N_P4_C2F_HIDDEN_C + c] = s->chunk1_center[c];
        s->cat[2u * YV8N_P4_C2F_HIDDEN_C + c] = s->bottleneck[c];
    }
...
static int run_c2f(const int8_t *input,
                   ...
                   yolov8n_p4_c2f_summary_t *summary)
{
    uint32_t points[YV8N_P4_C2F_MAX_COMPUTED_POINTS];
    uint32_t point_count;
    c2f_scratch_t *scratch;
    uint64_t sampled_hash = FNV1A64_INIT;
    uint64_t point_hash = FNV1A64_INIT;

    yolov8n_p5_arena_begin(YV8N_P4_C2F_SCRATCH_PEAK_BYTES);
    ...
    if (point_count > YV8N_P4_C2F_MAX_COMPUTED_POINTS)
        return -1;

    for (uint32_t i = 0; i < point_count; ++i) {
        uint32_t point = points[i];
        int8_t *out = output + (size_t)point * YV8N_P4_C2F_OUT_C;

        compute_c2f_point(input, point, scratch, out);
        point_hash = hash_u32_value(point_hash, point);
        sampled_hash = hash_i8_bytes(sampled_hash, out, YV8N_P4_C2F_OUT_C);
    }

    summary->magic = YV8N_P4_C2F_SUMMARY_MAGIC;
    summary->version = YV8N_P4_C2F_SUMMARY_VERSION;
    summary->input_bytes = YV8N_P4_C2F_INPUT_BYTES;
    summary->output_bytes = YV8N_P4_C2F_OUTPUT_BYTES;
    summary->input_h = YV8N_P4_C2F_IN_H;
    summary->input_w = YV8N_P4_C2F_IN_W;
    summary->input_c = YV8N_P4_C2F_IN_C;
    summary->output_c = YV8N_P4_C2F_OUT_C;
    summary->hidden_c = YV8N_P4_C2F_HIDDEN_C;
    summary->detect_sample_points = YV8N_P4_C2F_DETECT_SAMPLE_POINTS;
    summary->scratch_peak_bytes = YV8N_P4_C2F_SCRATCH_PEAK_BYTES;
    summary->sampled_output_points = point_count;
    summary->input_hash = hash_full_i8(input, YV8N_P4_C2F_INPUT_BYTES);
    summary->c2f_layer_hash = hash_c2f_layers();
    summary->output_hash = hash_full_i8(output, YV8N_P4_C2F_OUTPUT_BYTES);
    ...
    return (yolov8n_p5_arena_high_water() <= YV8N_P4_C2F_SCRATCH_PEAK_BYTES) ? 0 : -1;
}
                                        ...
                                        uint64_t *cls_hash)
{
    ...
    uint32_t y = point / YV8N_P4_C2F_IN_W;
    uint32_t x = point % YV8N_P4_C2F_IN_W;
    ...
    int32_t x1 = (cx_grid_q8 - (int32_t)left) * 16;
    int32_t y1 = (cy_grid_q8 - (int32_t)top) * 16;
    int32_t x2 = (cx_grid_q8 + (int32_t)right) * 16;
    int32_t y2 = (cy_grid_q8 + (int32_t)bottom) * 16;
    ...
    for (uint32_t oc = 0; oc < layer->K_out; ++oc) {
        ...
        for (uint32_t ky = 0; ky < layer->kH; ++ky) {
            ...
            for (uint32_t kx = 0; kx < layer->kW; ++kx) {
                ...
                if (iy < 0 || iy >= (int32_t)YV8N_P4_C2F_IN_H ||
                    ix < 0 || ix >= (int32_t)YV8N_P4_C2F_IN_W)
                    continue;

                for (uint32_t ic = 0; ic < layer->C_in; ++ic) {
                    size_t in_idx = (((size_t)(uint32_t)iy * YV8N_P4_C2F_IN_W +
                                      (uint32_t)ix) * YV8N_P4_C2F_OUT_C) + ic;
...
static void fill_detect_taps(
    ...
    uint8_t *valid)
{
    int32_t y = (int32_t)(point / YV8N_P4_C2F_IN_W);
    int32_t x = (int32_t)(point % YV8N_P4_C2F_IN_W);

    for (uint32_t tap = 0; tap < 9u; ++tap) {
        int32_t iy = y + (int32_t)(tap / 3u) - 1;
        int32_t ix = x + (int32_t)(tap % 3u) - 1;

        valid[tap] = (iy >= 0 && iy < (int32_t)YV8N_P4_C2F_IN_H &&
                      ix >= 0 && ix < (int32_t)YV8N_P4_C2F_IN_W) ? 1u : 0u;
        if (valid[tap]) {
                                ...
                                yolov8n_detect_summary_t *summary)
{
    ...
    box_public = yolov8n_p5_arena_alloc(
        YV8N_P4_C2F_DETECT_SAMPLE_POINTS * 4u * sizeof(*box_public), 64u);
    cls_public = yolov8n_p5_arena_alloc(
        YV8N_P4_C2F_DETECT_SAMPLE_POINTS * YV8N_DETECT_CLASS_CHANNELS *
    ...
    summary->scale_id = 1u;
    summary->input_bytes = YV8N_P4_C2F_OUTPUT_BYTES;
    summary->input_h = YV8N_P4_C2F_IN_H;
    summary->input_w = YV8N_P4_C2F_IN_W;
    summary->input_c = YV8N_P4_C2F_OUT_C;
    summary->stride = 16u;
    summary->raw_channels = YV8N_DETECT_RAW_CHANNELS;
    summary->public_channels = YV8N_DETECT_PUBLIC_CHANNELS;
    summary->sample_points = YV8N_P4_C2F_DETECT_SAMPLE_POINTS;
    summary->scratch_peak_bytes = YV8N_DETECT_SCRATCH_PEAK_BYTES;
    summary->input_hash = hash_full_i8(input, YV8N_P4_C2F_OUTPUT_BYTES);
...
static int validate_c2f_summary(const yolov8n_p4_c2f_summary_t *summary)
{
    if (summary->magic != YV8N_P4_C2F_SUMMARY_MAGIC ||
        summary->version != YV8N_P4_C2F_SUMMARY_VERSION ||
        summary->input_bytes != YV8N_P4_C2F_INPUT_BYTES ||
        summary->output_bytes != YV8N_P4_C2F_OUTPUT_BYTES ||
        summary->input_h != YV8N_P4_C2F_IN_H ||
        ...
        summary->detect_sample_points != YV8N_P4_C2F_DETECT_SAMPLE_POINTS ||
        summary->scratch_peak_bytes != YV8N_P4_C2F_SCRATCH_PEAK_BYTES ||
        summary->sampled_output_points != YV8N_P4_C2F_EXPECT_COMPUTED_POINTS ||
        summary->computed_point_count != YV8N_P4_C2F_EXPECT_COMPUTED_POINTS)
        return -1;
    if (summary->input_hash != YV8N_P4_C2F_EXPECT_INPUT_HASH ||
        summary->c2f_layer_hash != YV8N_P4_C2F_EXPECT_LAYER_HASH ||
        summary->output_hash != YV8N_P4_C2F_EXPECT_OUTPUT_HASH ||
        summary->sampled_output_hash != YV8N_P4_C2F_EXPECT_SAMPLED_HASH ||
        summary->computed_point_hash != YV8N_P4_C2F_EXPECT_POINT_HASH)
        return -1;
    for (uint32_t i = 0; i < YV8N_P4_C2F_DETECT_SAMPLE_POINTS; ++i) {
        if (summary->detect_sample_point_ids[i] != sample_points[i])
            return -1;
    }
    if (summary->first_output_q8[0] != YV8N_P4_C2F_EXPECT_FIRST0 ||
        summary->first_output_q8[1] != YV8N_P4_C2F_EXPECT_FIRST1 ||
        summary->first_output_q8[2] != YV8N_P4_C2F_EXPECT_FIRST2 ||
        summary->first_output_q8[3] != YV8N_P4_C2F_EXPECT_FIRST3)
        return -1;
    for (uint32_t i = 0; i < (uint32_t)(sizeof(summary->reserved) /
                                        sizeof(summary->reserved[0])); ++i) {
...
static int validate_detect_summary(const yolov8n_detect_summary_t *summary)
{
    if (summary->magic != YV8N_DETECT_SUMMARY_MAGIC ||
        ...
        summary->scratch_peak_bytes != YV8N_DETECT_SCRATCH_PEAK_BYTES)
        return -1;
    if (summary->input_hash != YV8N_P4_C2F_EXPECT_OUTPUT_HASH ||
        summary->layer_hash != UINT64_C(0x010eff3fa57a1f07) ||
        summary->raw_hash != YV8N_P4_C2F_DETECT_EXPECT_RAW_HASH ||
        summary->box_hash != YV8N_P4_C2F_DETECT_EXPECT_BOX_HASH ||
        summary->cls_hash != YV8N_P4_C2F_DETECT_EXPECT_CLS_HASH ||
        summary->public_hash != YV8N_P4_C2F_DETECT_EXPECT_PUBLIC_HASH)
        return -1;
    for (uint32_t i = 0; i < YV8N_P4_C2F_DETECT_SAMPLE_POINTS; ++i) {
    ...
    if (summary->first_box_q8[0] != YV8N_P4_C2F_DETECT_EXPECT_FIRST0 ||
        summary->first_box_q8[1] != YV8N_P4_C2F_DETECT_EXPECT_FIRST1 ||
        summary->first_box_q8[2] != YV8N_P4_C2F_DETECT_EXPECT_FIRST2 ||
        summary->first_box_q8[3] != YV8N_P4_C2F_DETECT_EXPECT_FIRST3)
        return -1;
    for (uint32_t i = 0; i < (uint32_t)(sizeof(summary->reserved) /
                                        sizeof(summary->reserved[0])); ++i) {
        if (summary->reserved[i] != 0u)
...
tpa_op_t yolov8n_p4_c2f_input_source_start(void)
{
    ...
    mark(YV8N_P4_C2F_TRACE_BEGIN);
    YV8N_DETECT_REQUIRE_MSG_STOP("Y8C4:SRCBUF\n", out != 0);
    fill_c2f_source_edge(out);
    mark(YV8N_P4_C2F_TRACE_SOURCE_SENT);
    return tpa_send(ch, out, YV8N_P4_C2F_INPUT_BYTES,
                    yolov8n_p4_c2f_input_source_done);
}
...
tpa_op_t yolov8n_p4_c2f_run(void)
{
    ...
    YV8N_DETECT_REQUIRE_MSG_STOP("Y8C4:LEN\n",
                                 w->input_len == YV8N_P4_C2F_INPUT_BYTES);
    YV8N_DETECT_REQUIRE_MSG_STOP("Y8C4:LAYERS\n", verify_c2f_layers() == 0);
    w->output = (int8_t *)tpa_send_buf(out_ch);
    YV8N_DETECT_REQUIRE_MSG_STOP("Y8C4:OUTBUF\n", w->output != 0);
    YV8N_DETECT_REQUIRE_MSG_STOP("Y8C4:RUN\n",
                                 run_c2f(w->input, w->output, &w->summary) == 0);
    mark(YV8N_P4_C2F_TRACE_C2F_DONE);
    return tpa_send(out_ch, w->output, YV8N_P4_C2F_OUTPUT_BYTES,
                    yolov8n_p4_c2f_send_summary);
}
...
tpa_op_t yolov8n_p4_c2f_send_summary(void)
{
    ...
    yolov8n_p4_c2f_summary_t *summary =
        (yolov8n_p4_c2f_summary_t *)tpa_send_buf(summary_ch);

    YV8N_DETECT_REQUIRE_MSG_STOP("Y8C4:SUMBUF\n", summary != 0);
    *summary = w->summary;
    return tpa_send(summary_ch, summary, sizeof(*summary), yolov8n_p4_c2f_done);
}
...
tpa_op_t yolov8n_p4_c2f_detect_run(void)
{
    ...
    YV8N_DETECT_REQUIRE_MSG_STOP("Y8C4DET:LEN\n",
                                 w->input_len == YV8N_P4_C2F_OUTPUT_BYTES);
    YV8N_DETECT_REQUIRE_MSG_STOP("Y8C4DET:LAYERS\n", verify_detect_layers() == 0);
    w->summary = (yolov8n_detect_summary_t *)tpa_send_buf(out_ch);
    YV8N_DETECT_REQUIRE_MSG_STOP("Y8C4DET:SUMBUF\n", w->summary != 0);
    YV8N_DETECT_REQUIRE_MSG_STOP("Y8C4DET:RUN\n",
                                 build_detect_summary(w->input, w->summary) == 0);
    mark(YV8N_P4_C2F_TRACE_DETECT_DONE);
    return tpa_send(out_ch, w->summary, sizeof(*w->summary),
                    yolov8n_p4_c2f_detect_done);
}
...
tpa_op_t yolov8n_p4_c2f_detect_checker_start(void)
{
    ...
    return tpa_recv(tpa_chan(0), (void **)&w->c2f_summary, &w->c2f_len,
                    yolov8n_p4_c2f_detect_checker_recv_detect);
}
...
tpa_op_t yolov8n_p4_c2f_detect_checker_recv_detect(void)
{
    ...
    return tpa_recv(tpa_chan(1), (void **)&w->detect_summary, &w->detect_len,
                    yolov8n_p4_c2f_detect_checker_run);
}
...
tpa_op_t yolov8n_p4_c2f_detect_checker_run(void)
{
    ...
    if (w->c2f_len != sizeof(*w->c2f_summary) ||
        w->detect_len != sizeof(*w->detect_summary) ||
        validate_c2f_summary(w->c2f_summary) ||
        validate_detect_summary(w->detect_summary)) {
        mark(YV8N_P4_C2F_TRACE_FAIL);
        TEST_FAIL;
        return tpa_stop();
    }

    mark(YV8N_P4_C2F_TRACE_CHECK_PASS);
    TEST_PASS;
    return tpa_stop();
}
